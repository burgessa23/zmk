...
static void draw_battery_status(lv_obj_t *widget, lv_color_t cbuf[], const struct status_state *state) {
...
static void draw_wpm(lv_obj_t *widget, lv_color_t cbuf[], const struct status_state *state) {
    ...
    // Fill background
    lv_canvas_draw_rect(canvas, 0, 0, DISP_WIDTH, DISP_WIDTH, &rect_black_dsc);
    ...
    lv_canvas_draw_rect(canvas, 1, 1, 66, 40, &rect_black_dsc);
